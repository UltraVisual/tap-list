      ...
      post: [
        new CodeBuildStep('DeployApp', {
          ...
          commands: [
            ...
            '  --parameters \'{"commands":["cd /home/ubuntu/tap-list && git pull && npm install --omit=dev && sudo -u ubuntu pm2 restart taplist"],"workingDirectory":["/home/ubuntu"],"executionTimeout":["120"]}\''+
